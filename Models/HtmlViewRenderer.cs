...
namespace Upload.Models
{
    public class HtmlViewRenderer
    {
        ...
        internal string RenderViewToString(EFTController eFTController, string v, MemoDetail result)
        {
            throw new NotImplementedException();
        }

        internal string RenderViewToString(EFTController eFTController, string viewName, ERATemplate result)
        {
            throw new NotImplementedException();
        }

        internal string RenderViewToString(EFTController eFTController, string v, DDTemplate result)
        {
            throw new NotImplementedException();
        }
    }
